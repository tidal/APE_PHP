...
require_once '../lib/ApeCurlConnection.php';

class ApeCurlConnectionTest extends ApeAbstractConnectionTest {


	protected $connection;

	protected function getConnection($port){
		return new ApeCurlConnection(APE_PHP_CONNECTION_HOST, $port, APE_PHP_CONNECTION_PROTOCOL);	
	}
	...
	protected function setUp(){	
		if (!@fsockopen(APE_PHP_CONNECTION_HOST, APE_PHP_CONNECTION_PORT, $errno, $errstr)) {
        	...
        	$this->markTestSkipped('CURL extension is not installed');
        }	
